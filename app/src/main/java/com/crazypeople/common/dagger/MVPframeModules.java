...
import com.crazypeople.common.config.Constants;
...
public class MVPframeModules {
    ...
    protected OkHttpClient getClient() {
        return new OkHttpClient.Builder().connectTimeout(50000, TimeUnit.MILLISECONDS).readTimeout(
                50000, TimeUnit.MILLISECONDS).addInterceptor(new HttpLoggingInterceptor().setLevel(
